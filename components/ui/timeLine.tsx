...
export const Timeline = ({ data}: { data: TimelineEntry[]}) => {
  ...
  return (
    <div
      className="w-full bg-white dark:bg-neutral-950 font-sans overflow-hidden"
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10 text-center">
        ...
        <p className="text-neutral-700 dark:text-neutral-300 text-2xl font-bold">
          A small selection of <span className="text-4xl text-purple font-extraboldd font-sans">recent projects</span>
        </p>
      </div>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-white dark:bg-black hidden md:flex items-center justify-center">
            ...
            <div className="relative pl-5 pr-4 md:pl-4 w-full">
